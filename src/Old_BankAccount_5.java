...
public class Old_BankAccount_5 {
...
//    static List<BankAccount> listOfBankAcc; // Arraylist to store BankAccount objects
    ...
    static OldBankAccount[] listOfBankAcc = new OldBankAccount[10];
...
//        }
    ...
    //                            dataPersistency(listOfBankAcc); // Writing to file
                            ...
                            for (OldBankAccount forAccount : listOfBankAcc) {
                ...
                case '2':
                    ...
                    for(OldBankAccount bankAccount: listOfBankAcc){
                ...
                case '4':
                    ...
                    for(OldBankAccount acc: listOfBankAcc){
                        System.out.printf(
                                "Account Number: %s \n" +
                                "Account Balance: %,.2f \n" +
                                "Customer Name: %s \n" +
                ...
                case '5':
                    ...
                    try {
                        ...
                        for(OldBankAccount searchAcc: listOfBankAcc){
    ...
    public static void processMoneyTransfer (int paramFrom, int paramToAcc, double transactVal)
        ...
        OldBankAccount fromBankAcc = null;
        OldBankAccount toBankAcc = null;
    ...
    public static void showAccBalForecast(OldBankAccount account, int months){
    ...
    public static ArrayList<OldBankAccount> dataPersistency(){
        // METHOD FOR READING FROM FILE
        FileInputStream fis = null;
        ObjectInputStream ois = null;
        ArrayList<OldBankAccount> listOfBankAcc = null;

        try {
            fis = new FileInputStream(new File("Accounts.txt"));
            ois = new ObjectInputStream(fis);
            listOfBankAcc = (ArrayList<OldBankAccount>) ois.readObject();
    ...
    public static void dataPersistency(List<OldBankAccount> listOfAccounts){
    ...
    public static OldBankAccount enterAccountData() throws Exception{
        System.out.println(
                "==============================\n" +
        ...
        return new OldBankAccount(accountNumber, accountBalance, customerName,
                password, interestRate, autoDeposit, autoWithdraw);
    }

    public static void computeInterest(OldBankAccount account, int noOfYears){
    ...
    public static void displayAccount(OldBankAccount account){
